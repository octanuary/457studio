package anifire.studio.skins
{
   ...
   public class RemoveBulkAssetTransitionButtonSkin extends SparkButtonSkin implements IStateClient2
   {
      ...
      public function RemoveBulkAssetTransitionButtonSkin()
      {
         ...
         this.minWidth = 21;
         this.minHeight = 21;
         this.mxmlContent = [this._RemoveBulkAssetTransitionButtonSkin_HGroup1_c()];
      ...
      private function _RemoveBulkAssetTransitionButtonSkin_HGroup1_c() : HGroup
      {
         var _loc1_:HGroup = new HGroup();
         _loc1_.verticalAlign = "middle";
         _loc1_.mxmlContent = [this._RemoveBulkAssetTransitionButtonSkin_Label1_i(),this._RemoveBulkAssetTransitionButtonSkin_BitmapImage1_c()];
         if(!_loc1_.document)
         {
      ...
      private function _RemoveBulkAssetTransitionButtonSkin_Label1_i() : Label
      {
