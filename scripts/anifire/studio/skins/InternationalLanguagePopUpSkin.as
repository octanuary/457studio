package anifire.studio.skins
{
   ...
   public class InternationalLanguagePopUpSkin extends Skin implements IBindingClient, IStateClient2
   {
      ...
      public function InternationalLanguagePopUpSkin()
      {
         ...
         bindings = this._InternationalLanguagePopUpSkin_bindingsSetup();
         var watchers:Array = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_anifire_studio_skins_InternationalLanguagePopUpSkinWatcherSetupUtil");
         ...
         {
            return InternationalLanguagePopUpSkin[param1];
         },bindings,watchers);
         mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
         mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
         this.mxmlContent = [this._InternationalLanguagePopUpSkin_Group1_i()];
      ...
      {
         InternationalLanguagePopUpSkin._watcherSetupUtil = param1;
      }
      ...
      private function _InternationalLanguagePopUpSkin_Group1_i() : Group
      {
         var _loc1_:Group = new Group();
         _loc1_.mxmlContent = [this._InternationalLanguagePopUpSkin_Panel1_i(),this._InternationalLanguagePopUpSkin_Button3_i()];
         _loc1_.id = "chrome";
         if(!_loc1_.document)
         {
      ...
      private function _InternationalLanguagePopUpSkin_Panel1_i() : Panel
      {
         var _loc1_:Panel = new Panel();
         _loc1_.minWidth = 200;
         _loc1_.maxWidth = 450;
         _loc1_.layout = this._InternationalLanguagePopUpSkin_VerticalLayout1_c();
         _loc1_.controlBarContent = [this._InternationalLanguagePopUpSkin_Button1_i(),this._InternationalLanguagePopUpSkin_Button2_i()];
         _loc1_.mxmlContentFactory = new DeferredInstanceFromFunction(this._InternationalLanguagePopUpSkin_Array7_c);
         _loc1_.id = "panel";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
      ...
      private function _InternationalLanguagePopUpSkin_VerticalLayout1_c() : VerticalLayout
      {
      ...
      private function _InternationalLanguagePopUpSkin_Button1_i() : Button
      {
      ...
      private function _InternationalLanguagePopUpSkin_Button2_i() : Button
      {
         var _loc1_:Button = new Button();
         _loc1_.buttonMode = true;
      ...
      private function _InternationalLanguagePopUpSkin_Array7_c() : Array
      {
         var _loc1_:Array = [this._InternationalLanguagePopUpSkin_HGroup1_c()];
         return _loc1_;
      }
      
      private function _InternationalLanguagePopUpSkin_HGroup1_c() : HGroup
      {
         ...
         _loc1_.mxmlContent = [this._InternationalLanguagePopUpSkin_BitmapImage1_i(),this._InternationalLanguagePopUpSkin_VGroup1_c()];
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
      ...
      private function _InternationalLanguagePopUpSkin_BitmapImage1_i() : BitmapImage
      {
      ...
      private function _InternationalLanguagePopUpSkin_VGroup1_c() : VGroup
      {
         var _loc1_:VGroup = new VGroup();
         _loc1_.percentWidth = 100;
         _loc1_.percentHeight = 100;
         _loc1_.gap = 10;
         _loc1_.mxmlContent = [this._InternationalLanguagePopUpSkin_Label1_i(),this._InternationalLanguagePopUpSkin_RichEditableText1_c()];
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
      ...
      private function _InternationalLanguagePopUpSkin_Label1_i() : Label
      {
      ...
      private function _InternationalLanguagePopUpSkin_RichEditableText1_c() : RichEditableText
      {
         var _loc1_:RichEditableText = new RichEditableText();
         _loc1_.percentWidth = 100;
         _loc1_.editable = false;
         _loc1_.focusEnabled = false;
         _loc1_.textFlow = this._InternationalLanguagePopUpSkin_TextFlow1_c();
      ...
      private function _InternationalLanguagePopUpSkin_TextFlow1_c() : TextFlow
      {
         var _loc1_:TextFlow = new TextFlow();
         _loc1_.mxmlChildren = ["\n                                ",this._InternationalLanguagePopUpSkin_ParagraphElement1_c(),"\n                                ",this._InternationalLanguagePopUpSkin_ParagraphElement2_c(),"\n                                ",this._InternationalLanguagePopUpSkin_ParagraphElement3_c(),"\n                            "];
         _loc1_.initialized(this,null);
         return _loc1_;
      }
      
      private function _InternationalLanguagePopUpSkin_ParagraphElement1_c() : ParagraphElement
      {
         var _loc1_:ParagraphElement = new ParagraphElement();
         _loc1_.paddingTop = 10;
         _loc1_.mxmlChildren = ["It looks like the text you\'ve entered contains some unsupported characters."];
         _loc1_.initialized(this,null);
         return _loc1_;
      }
      
      private function _InternationalLanguagePopUpSkin_ParagraphElement2_c() : ParagraphElement
      {
         var _loc1_:ParagraphElement = new ParagraphElement();
         _loc1_.paddingTop = 10;
         _loc1_.mxmlChildren = ["We suggest switching to the \"Noto\" Font. There may be a short delay while the font is loading."];
         _loc1_.initialized(this,null);
         return _loc1_;
      }
      
      private function _InternationalLanguagePopUpSkin_ParagraphElement3_c() : ParagraphElement
      {
         var _loc1_:ParagraphElement = new ParagraphElement();
         _loc1_.paddingTop = 10;
         _loc1_.mxmlChildren = ["Learn more about support for ",this._InternationalLanguagePopUpSkin_LinkElement1_c(),"."];
         _loc1_.initialized(this,null);
         return _loc1_;
      }
      
      private function _InternationalLanguagePopUpSkin_LinkElement1_c() : LinkElement
      {
         ...
         _loc1_.mxmlChildren = [this._InternationalLanguagePopUpSkin_SpanElement1_c()];
         _loc1_.initialized(this,null);
         return _loc1_;
      }
      
      private function _InternationalLanguagePopUpSkin_SpanElement1_c() : SpanElement
      {
      ...
      private function _InternationalLanguagePopUpSkin_Button3_i() : Button
      {
         var _loc1_:Button = new Button();
      ...
      private function _InternationalLanguagePopUpSkin_bindingsSetup() : Array
      {
         var result:Array = [];
