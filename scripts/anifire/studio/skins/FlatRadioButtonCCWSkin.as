package anifire.studio.skins
{
   ...
   public class FlatRadioButtonCCWSkin extends SparkSkin implements IStateClient2
   {
      ...
      private var _embed_mxml__styles_images_panel_icon_anticlockwise_png_85953417:Class;
      
      private var _213507019hostComponent:RadioButton;
      
      public function FlatRadioButtonCCWSkin()
      {
         this._embed_mxml__styles_images_common_radio_selected_png_1898210761 = FlatRadioButtonCCWSkin__embed_mxml__styles_images_common_radio_selected_png_1898210761;
         this._embed_mxml__styles_images_common_radio_base_png_1747381759 = FlatRadioButtonCCWSkin__embed_mxml__styles_images_common_radio_base_png_1747381759;
         this._embed_mxml__styles_images_panel_icon_anticlockwise_png_85953417 = FlatRadioButtonCCWSkin__embed_mxml__styles_images_panel_icon_anticlockwise_png_85953417;
         super();
         mx_internal::_document = this;
         this.mxmlContent = [this._FlatRadioButtonCCWSkin_HGroup1_c()];
      ...
      private function _FlatRadioButtonCCWSkin_HGroup1_c() : HGroup
      {
         var _loc1_:HGroup = new HGroup();
         _loc1_.gap = 10;
         _loc1_.mxmlContent = [this._FlatRadioButtonCCWSkin_BitmapImage1_i(),this._FlatRadioButtonCCWSkin_BitmapImage2_i()];
         if(!_loc1_.document)
         {
      ...
      private function _FlatRadioButtonCCWSkin_BitmapImage1_i() : BitmapImage
      {
      ...
      private function _FlatRadioButtonCCWSkin_BitmapImage2_i() : BitmapImage
      {
         var _loc1_:BitmapImage = new BitmapImage();
         _loc1_.verticalCenter = -1;
         _loc1_.smooth = true;
         _loc1_.source = this._embed_mxml__styles_images_panel_icon_anticlockwise_png_85953417;
