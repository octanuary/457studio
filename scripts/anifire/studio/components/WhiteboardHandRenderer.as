package anifire.studio.components
{
   ...
   public class WhiteboardHandRenderer extends ItemRenderer implements IStateClient2
   {
      ...
      private var _embed_mxml__styles_images_hands_hand_selected_png_183595839:Class;
      
      public function WhiteboardHandRenderer()
      {
         this._embed_mxml__styles_images_hands_hand_selected_png_183595839 = WhiteboardHandRenderer__embed_mxml__styles_images_hands_hand_selected_png_183595839;
         super();
      ...
      private function _WhiteboardHandRenderer_BitmapImage1_i() : BitmapImage
      {
         ...
         _loc1_.source = this._embed_mxml__styles_images_hands_hand_selected_png_183595839;
         _loc1_.top = -8;
         _loc1_.right = -12;
